...
define( 'COMMONSBOOKING_VERSION', '2.10.10' );
...
// Optional third-party integrations (loaded conditionally, no hard dependency).
require_once __DIR__ . '/integrations/uncanny-automator/bootstrap.php';
