 ...
 *
 * This replaces the former runtime (WP_DEBUG) schema validation. The schema
 * validator (opis/json-schema) is now a dev-only dependency, so conformance is
 * asserted here in CI instead of being shipped and validated in production.
 */
